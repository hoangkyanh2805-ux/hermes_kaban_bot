# ops/ — Operator & clone kit

| File | Dùng khi |
|------|----------|
| **[OPS-BUNDLER.md](OPS-BUNDLER.md)** | Bắt đầu — map Step 1–2–3 + OPS runtime |
| **[CREDENTIALS-AND-KEYS.md](CREDENTIALS-AND-KEYS.md)** | **Lấy API, điền key, Supabase setup** |
| [clone-checklist.md](clone-checklist.md) | Fork repo → dự án niche mới |
